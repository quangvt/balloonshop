...
namespace BalloonShop.Test
{
    ...
    public class RouteTests
    {
        ...
        public void TestIncomingRoutes()
        {
            ...
            TestRouteFail("~/Product/List/Segment");
            //TestRouteFail("~/Product"); //=> match {category} => not fail

            TestRouteMatch("~/", "Product", "List");

            TestRouteMatch("~/Shop/List", "Product", "List");

            TestRouteMatch("~/Shop/OldAction", "Product", "List");

            TestRouteMatch("~/Custom/Product/Edit/Hello", "Product", "Edit", new { id = "Hello" } );

            TestRouteMatch("~/Custom/Product/Edit", "Product", "Edit", new { id = "DefaultId" } );
