...
namespace BalloonShop.Common
{
    ...
    {
        public static object BalloonShopConfiguration { get; private set; }
            ...
            string body)
        {
            ...
            SmtpClient(Configuration.MailServer);
            // Set credentials (for SMTP servers that require authentication)
            mailClient.Credentials = new NetworkCredential(Configuration.MailUsername,
